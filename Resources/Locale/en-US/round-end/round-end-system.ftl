...
round-end-system-shuttle-called-announcement = A train has been dispatched. ETA: {$time} {$units}.
round-end-system-shuttle-countdown-announcement = The train is due in {$time} {$units}.
...
round-end-system-shuttle-auto-called-announcement = An automatic outbound train has been dispatched. ETA: {$time} {$units}. Recall the train to extend the shift.
