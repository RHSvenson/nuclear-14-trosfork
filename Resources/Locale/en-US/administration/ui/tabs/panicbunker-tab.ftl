...
misfits-panic-bunker-count-deadmin-desc = Count deadminned admins when deciding whether to auto-toggle panic bunker.
misfits-panic-bunker-show-reason-desc = Show blocked players the reason panic bunker denied their connection.
misfits-panic-bunker-min-age-desc = Minimum account age required to join while panic bunker is enabled.
misfits-panic-bunker-min-hours-desc = Minimum overall server playtime required to join while panic bunker is enabled.
